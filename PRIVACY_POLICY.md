...
- Nutritional information and daily goals
- Food product records

### Reminders

You may create reminders that include titles, categories, recurrence schedules, priority levels, and notification preferences.
...
All data is stored locally on your device using Apple's SwiftData framework with a SQLite database.
...
Your data persists on your device and in your iCloud account for as long as you use the app. If you sign out of a household, your data remains stored in iCloud. You can delete individual records within the app at any time. To remove all data, you can delete the app from your device and remove its data from iCloud via your device's iCloud storage settings.
